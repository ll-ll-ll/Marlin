 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 640, 1357 }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 120, 120, 3, 18 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 30, 0, -2.87 }
...
#define Z_CLEARANCE_MULTI_PROBE     0.15 // Z Clearance between multiple probes
