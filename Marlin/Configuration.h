...
#define STRING_CONFIG_H_AUTHOR "(GeeeTech I3, Default config)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Moonlander"
...
#define PID_K1 0.98      // Smoothing factor within any PID loop
 ...
 */
  ...
  #define MPC_HEATER_POWER { 20.0f }                  // (W) Heat cartridge powers.

  #define MPC_INCLUDE_FAN                             // Model the fan speed?

  // Measured physical constants from M306
  #define MPC_BLOCK_HEAT_CAPACITY { 9.58f }           // (J/K) Heat block heat capacities.
  #define MPC_SENSOR_RESPONSIVENESS { 0.1541f }         // (K/s per ∆K) Rate of change of sensor temperature from heat block.
  #define MPC_AMBIENT_XFER_COEFF { 0.0660f }           // (W/K) Heat transfer coefficients from heat block to room air with fan off.
  #if ENABLED(MPC_INCLUDE_FAN)
    #define MPC_AMBIENT_XFER_COEFF_FAN255 { 0.0859f }  // (W/K) Heat transfer coefficients from heat block to room air with fan on full.
  #endif
  ...
  #define FILAMENT_HEAT_CAPACITY_PERMM { 5.6e-3f }  // 0.0036 J/K/mm for 1.75mm PETG (0.0094 J/K/mm for 2.85mm PETG).

  // Advanced options
  #define MPC_SMOOTHING_FACTOR 0.3f                   // (0.0...1.0) Noisy temperature sensors may need a lower value for stabilization.
...
#define MAX_BED_POWER 225 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 111.72
  #define DEFAULT_bedKi 22.00
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 160, 160, 1280, 816.66 }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 120, 120, 3, 30 }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 7000, 7000, 1500, 5000 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 30, 0, -2.75 }
...
#define Z_CLEARANCE_MULTI_PROBE     0.35 // Z Clearance between multiple probes
...
#define DEBUG_LEVELING_FEATURE
  ...
  //#define AVOID_OBSTACLES
    ...
    #define CLIP_W  8  // Bed clip width, should be padded a few mm over its physical size
 ...
 */
#define Z_PROBE_END_SCRIPT "G0 X164 Y-9 Z15\nG0 X167 Y-12\nG0 Z7.05\nG0 Z15\nG0 X164 Y-9 Z15\nG0 X76 Y182 Z15"
...
#define HOMING_FEEDRATE_MM_M { (40*60), (40*60), (2*60) }
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MIN_POS ), (Y_MIN_POS ), 2 }
