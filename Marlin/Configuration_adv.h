 ...
 */
#define FAN_KICKSTART_TIME  50  // (ms)
...
//#define ASSISTED_TRAMMING
  ...
  #define TRAMMING_POINT_XY { {  36, 6 }, { 177,  6 }, { 177, 177 }, { 36, 177 } }
...
#define DEFAULT_MINTRAVELFEEDRATE     20.0     // (mm/s. °/s for rotational-only moves) Minimum travel feedrate. Set with M205 T.
 ...
 */
#define XY_FREQUENCY_LIMIT      8 // (Hz) Maximum frequency of small zigzag infill moves. Set with M201 F<hertz>.
...
#define MICROSTEP_MODES { 16, 16, 4, 32 } // [1,2,4,8,16]
...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 40*60, 40*60, 3*60, 2*60 } // (mm/min) Feedrates for manual moves along X, Y, Z, E from panel
 ...
 */
   ...
   */
  //#define DISPLAY_SLEEP_MINUTES 1  // (minutes) Timeout before turning off the screen. Set with M255 S.
 ...
 */
  ...
  #define PROBING_MARGIN_FRONT PROBING_MARGIN+8
...
//#define G29_RETRY_AND_RECOVER
  ...
  #define G29_RECOVER_COMMANDS "M117 Probe failed. Retry"
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define ADVANCED_PAUSE_RESUME_PRIME          0.2  // (mm) Extra distance to prime nozzle after returning from park.
...
#define G0_Z_FEEDRATE 180 // (mm/min)
#ifdef G0_FEEDRATE
...
//#define CUSTOM_MENU_MAIN
  ...
  #define CUSTOM_MENU_MAIN_TITLE "Performance mode"
  #define CUSTOM_MENU_MAIN_SCRIPT_DONE "performance mode changed"
  #define CUSTOM_MENU_MAIN_SCRIPT_AUDIBLE_FEEDBACK
  //#define CUSTOM_MENU_MAIN_SCRIPT_RETURN   // Return to status screen after a script
  #define CUSTOM_MENU_MAIN_ONLY_IDLE         // Only show custom menu when the machine is idle

  #define MAIN_MENU_ITEM_1_DESC "Silent Mode"
  #define MAIN_MENU_ITEM_1_GCODE "M203 X40 Y40 Z2 E45\nM204 P7000 R500 T7000\nM906 X450 Y450 Z600 E900"
  //#define MAIN_MENU_ITEM_1_CONFIRM          // Show a confirmation dialog before this action

  #define MAIN_MENU_ITEM_2_DESC "Performance Mode "
  #define MAIN_MENU_ITEM_2_GCODE "M906 X800 Y800 Z950 E1050\nM203 X200 Y200 Z5 E45\nM204 P10000 R500 T10000"
